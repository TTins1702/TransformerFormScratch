...
def generate_tex_file(filename="Bao_cao_Mini_Transformer.tex"):
...
\end{document}
"""
    # Thay thế dấu đóng ngoặc tròn sai cú pháp trên dòng document
    content = content.replace("begin{document()", "begin{document}")
    
    with open(filename, "w", encoding="utf-8") as f:
        f.write(content)
    print(f"LaTeX file generated successfully: {filename}")
